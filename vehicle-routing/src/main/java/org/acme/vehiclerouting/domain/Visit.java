...
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;//Petr
import org.acme.vehiclerouting.domain.rest.LocalDateTimeDeserializer;//Petr
import org.acme.vehiclerouting.domain.rest.ServiceDurationDeserializer;//Petr
...
public class Visit {
    ...
    private int demand;
    //Petr private LocalDateTime departureTime;
    @JsonDeserialize(using = LocalDateTimeDeserializer.class)
    private LocalDateTime minStartTime;
    //Petr private LocalDateTime maxEndTime;
    @JsonDeserialize(using = LocalDateTimeDeserializer.class)
    private LocalDateTime maxEndTime;
    //Petr private LocalDateTime serviceDuration;
    //@JsonDeserialize(using = ServiceDurationDeserializer.class)
    ...
    //Petr private LocalDateTime arrivalTime;
    @JsonDeserialize(using = LocalDateTimeDeserializer.class)
    ...
    //Petr Method to set serviceDuration using an int value representing seconds
    public void setServiceDurationInSeconds(int seconds) {
        this.serviceDuration = Duration.ofSeconds(seconds);
    }
