...
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;//Petr
...
public class VehicleRouteDemoResource {
    ...
    public VehicleRoutePlan generate(@Parameter(description = "Unique identifier of the demo data.",
            required = true) @PathParam("demoDataId") String demoDataId) throws IOException {
        //String filePath = "path/to/your/json/file.json"; // Path to your JSON file
        String filePath = "src/main/resources/json/scope_definition.json";
        VehicleRoutePlan vehicleRoutePlan = readFromJsonFile(filePath);
        return vehicleRoutePlan;
    }

    private VehicleRoutePlan readFromJsonFile(String filePath) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.registerModule(new JavaTimeModule());
        String json = new String(Files.readAllBytes(Paths.get(filePath)));
        return objectMapper.readValue(json, VehicleRoutePlan.class);
    }
...
//import org.eclipse.microprofile.openapi.annotations.responses.APIResponses;
//import org.eclipse.microprofile.openapi.annotations.tags.Tag;
//import java.io.IOException;//Petr
//import com.fasterxml.jackson.databind.ObjectMapper;//Petr
//import java.io.File;//Petr
//
//@Tag(name = "Demo data", description = "Timefold-provided demo vehicle routing data.")
//@Path("demo-data")
//public class VehicleRouteDemoResource {
...
//        PRAGUE(2, 3, 1, LocalTime.of(7, 30),
//                1, 2, 20, 40,
//                new Location(49.9898925, 14.2466044),//levy spodni
//                new Location(50.1577947, 14.6290661)),
...
//                1, 2, 20, 40,
//                new Location(43.751466, 11.177210),
//                new Location(43.809291, 11.290195));
//
//        private long seed;
...
////    @GET
////    @Path("/{demoDataId}")
////    public VehicleRoutePlan generate(@PathParam("demoDataId") String demoDataId) throws IOException {
...
////    private VehicleRoutePlan readFromJsonFile(String filePath) throws IOException {
////        ObjectMapper objectMapper = new ObjectMapper();
////        VehicleRoutePlan vehicleRoutePlan = objectMapper.readValue(new File(filePath), VehicleRoutePlan.class);
////        return vehicleRoutePlan;
////    }
////    //*****************
//
