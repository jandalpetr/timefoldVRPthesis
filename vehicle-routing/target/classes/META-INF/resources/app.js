...
function fetchDemoData() {
    ...
    // Define hardcoded demo data for Prague
    const data = ["PRAGUE", "Berlin", "Data3"]; // Replace with your actual data
    console.log(data);
    console.log("XXX");
    ...
    $.get("/demo-data", function (data) {
        ...
        //Petr $("#demo").empty();
        $("#demo").html("<h1><p style=\"justify-content: center\">No test data availableXXX</p></h1>")
    });
}
